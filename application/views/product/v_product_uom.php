                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <div class="form-group">
                              ...
                              <input type="text" name="name" id="name" class="form-control" placeholder="Meter/Sentimeter/Unit" title="Only characters." pattern="^[a-zA-Z]+$" minlength="1" maxlength="100" required>
                          </div>
                          <div class="form-group">
                              <label>Symbol</label>
                              <input type="text" name="symbol" id="symbol" class="form-control" placeholder="m/cm/unit" title="Only alphanumeric characters, - , . ,_ and @."  pattern="^[a-zA-Z0-9.-_@\s]+$" minlength="1" maxlength="15">
                          </div>
                      </div>
  ...
  <script>
      $(document).ready(function() {
          ...
          $('#btn_sample').on('click', function() {
              window.open("<?= site_url('product/export_sample_data_uom') ?>");
          })
          ...
          $('#form_upload').on('submit', function(e) {
              ...
              $.ajax({
                  url: "<?= site_url('product/save_upload_data_uom') ?>",
                  data: formData,
                  processData: false,
                  contentType: false,
                  async: false,
