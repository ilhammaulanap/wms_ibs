                  ...
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <div class="form-group">
                              ...
                              <input type="text" name="username"  title="Only alphanumeric characters, - , . ,_ and @."  pattern="^[a-zA-Z0-9.-_@\s]+$" minlength="5" maxlength="12" id="username" class="form-control" placeholder="Username" required>
                          </div>
                          <div class="form-group">
                              <label>Name</label>
                              <input type="text" name="name" id="name" title="Only characters." pattern="^[a-zA-Z\s]+$" minlength="5" maxlength="50" class="form-control" placeholder="Name" required>
                          </div>
                          <div class="form-group">
                              <label>Email</label>
                          ...
                          <div class="form-group">
                              ...
                              <input type="password" name="password" minlength="5" maxlength="50" id="password" class="form-control" placeholder="Password" required>
  ...
  <script>
      $(document).ready(function() {
          ...
          $('#btn_sample').on('click', function() {
              window.open("<?= site_url('user/export_sample_data') ?>");
          })
          ...
          $('#form_upload').on('submit', function(e) {
              ...
              $.ajax({
                  url: "<?= site_url('user/save_upload_data') ?>",
                  data: formData,
                  processData: false,
                  contentType: false,
                  async: false,
