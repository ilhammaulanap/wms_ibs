  ...
  <script>
      $(document).ready(function() {
          ...
          var table = $('#table_mot').DataTable({
              ajax: {
                  url: "<?= site_url('mot/get_ajax_data_mot') ?>",
                  type: 'POST'
              },
              order: [],
              "responsive": true,
          ...
          $('#btn_sample').on('click', function() {
              window.open("<?= site_url('mot/export_sample_data') ?>");
          })
          ...
          $('#form_upload').on('submit', function(e) {
              ...
              $.ajax({
                  url: "<?= site_url('mot/save_upload_data') ?>",
                  data: formData,
                  processData: false,
                  contentType: false,
                  async: false,
