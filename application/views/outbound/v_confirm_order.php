                    ...
                    <div class="card card-primary">
                        ...
                        <form id="form_order" method="POST">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" name="outbound_date" id="inbound_date" class="form-control" min="<?= date('Y-m-d') ?>" required>
                                            </div>
                                            <div class="col-md-3">
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="id_destination" id="id_destination" class="form-control select2" required></select>
                                            </div>
                                            <div class="col-md-3">
                                                <label>Creator</label>
                                    ...
                                    <div class="col-md-12 mt-2">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="date" name="dispatch_date" id="dispatch_date" class="form-control" autofocus required>
                                            </div>
                                            <div class="col-md-3">
                                                <label>Dispatch Time</label>
                                                <input type="time" name="dispatch_time" id="dispatch_time" class="form-control" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label>Loading Start</label>
                                                <input type="time" name="loading_start" id="loading_start" class="form-control" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label>Loading Finish</label>
                                                <input type="time" name="loading_finish" id="loading_finish" class="form-control" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-bordered" id="table_inbound">
                                            <thead>
                                                <tr>
                                                    <th>No</th>
                                                    <th>Material Name</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <input class="form-control" type="text" name="product_name[]" readonly>
                                                    </td>
                                                    <td>
                                                        <input class="form-control" type="text" name="site_name[]" readonly>
                                                    </td>
                                                    <td>
                                                        <input class="form-control" type="number" name="qty[]" readonly>
                                                    </td>
                                                    <td>
                                                        <select class="form-control" type="text" name="id_locator[]"></select>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4">
